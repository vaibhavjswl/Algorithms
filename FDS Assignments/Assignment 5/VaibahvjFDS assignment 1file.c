...
main ()
{
	...
	printf("3.To Print Floyd's Triangle\n");
...
void maxmofthreeno()
{
	...
	if (maxm>=num1) printf ("Number 2 i.e %f is the maximum",num2);
	else if (num1>=num3) printf ("Number 1 i.e %f is maximum",num1);
	else printf ("Number 3 i.e %f is maximum",num3);
